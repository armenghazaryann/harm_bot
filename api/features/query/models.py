...
class QueryContextModel(BaseModel):
    ...
    def get_context_text(self, max_chunks: int = 5) -> str:
        ...
        for result in self.search_results[:max_chunks]:
            context_chunks.append(f"[Document: {result.document_filename}]\n{result.chunk.content}")
    ...
    def get_citations(self) -> List[Dict[str, Any]]:
        ...
        for i, result in enumerate(self.search_results):
            citations.append({
                ...
                "content_excerpt": result.chunk.content[:200] + "..." if len(result.chunk.content) > 200 else result.chunk.content,
...
class AnswerModel(BaseModel):
    ...
    def to_answer_response_dto(self):
        ...
        return AnswerResponse(
            ...
            processing_time_ms=self.context.processing_time_ms + self.generation_time_ms,
